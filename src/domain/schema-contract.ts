...
export const TARGET_CONTRACT: Record<string, DataSourceContract> = {
  NOTION_DS_ACCOUNTS: {
    ...
    properties: [
      ...
      { domainField: 'source', notionProperty: 'Fonte', notionType: 'select', direction: 'both', authority: 'UPSTREAM', description: 'Sistema ou conector de origem (ex: PIERRE, MANUAL, MIGRATION, OTHER)', aliases: ['Origem', 'Conector', 'Sistema Origem', 'Fonte'], expectedOptions: ['Pierre', 'Manual', 'Migração', 'Outra'], optionMappings: { 'Pierre': 'PIERRE', 'Manual': 'MANUAL', 'Migração': 'MIGRATION', 'Outra': 'OTHER' }, allowExtraOptions: true },
      ...
      { domainField: 'currency', notionProperty: 'Moeda', notionType: 'select', direction: 'both', authority: 'UPSTREAM', description: 'Código da moeda da conta (ex: BRL, USD)', aliases: ['Moeda da Conta', 'Currency', 'Divisa', 'Moeda'], expectedOptions: ['BRL', 'USD', 'EUR'] },
      { domainField: 'institution', notionProperty: 'Instituição', notionType: 'select', direction: 'both', authority: 'UPSTREAM', description: 'Nome do banco / conector (ex: Nubank, Mercado Pago)', aliases: ['Banco', 'Instituicao', 'Instituição'], expectedOptions: ['Nubank', 'Mercado Pago', 'Itaú', 'Bradesco', 'Santander', 'Inter', 'BTG Pactual', 'XP', 'Outro'], allowExtraOptions: true },
      { domainField: 'type', notionProperty: 'Tipo de Conta', notionType: 'select', direction: 'both', authority: 'UPSTREAM', description: 'CHECKING_ACCOUNT, CREDIT_CARD, SAVINGS', aliases: ['Tipo', 'Tipo Conta', 'Tipo de Conta', 'Tipo de conta'], expectedOptions: ['Conta Corrente', 'Cartão de Crédito', 'Conta Poupança', 'Conta de Investimento', 'Carteira Dinheiro'], optionMappings: { 'Conta Corrente': 'CHECKING_ACCOUNT', 'Cartão de Crédito': 'CREDIT_CARD', 'Conta Poupança': 'SAVINGS_ACCOUNT', 'Conta de Investimento': 'INVESTMENT_ACCOUNT', 'Carteira Dinheiro': 'CASH_WALLET' } },
      ...
      { domainField: 'contractedCreditLimit', notionProperty: 'Limite Contratado', notionType: 'number', direction: 'write', authority: 'UPSTREAM', description: 'Limite total concedido pelo banco (ex: R$ 2.400)', aliases: ['Limite', 'Limite Total', 'Limite Contratado'] },
      ...
      { domainField: 'availableCreditLimit', notionProperty: 'Limite Disponível', notionType: 'number', direction: 'write', authority: 'UPSTREAM', description: 'Limite de crédito livre no momento', aliases: ['Disponível', 'Limite Livre', 'Limite Disponível'] },
      ...
      { domainField: 'rawUsedCreditLimit', notionProperty: 'Limite Usado (Pierre Bruto)', notionType: 'number', direction: 'write', authority: 'UPSTREAM', description: 'Valor bruto reportado pelo Pierre para auditoria de inconsistência', aliases: ['Limite Bruto Pierre', 'Limite Usado (Pierre Bruto)'] },
  ...
  NOTION_DS_TRANSACTIONS: {
    ...
    properties: [
      ...
      { domainField: 'currency', notionProperty: 'Moeda', notionType: 'select', direction: 'both', authority: 'UPSTREAM', description: 'Código da moeda da transação (ex: BRL, USD)', aliases: ['Moeda da Transação', 'Currency', 'Moeda'], expectedOptions: ['BRL', 'USD', 'EUR'] },
      ...
      { domainField: 'rawAmount', notionProperty: 'Valor Bruto Pierre', notionType: 'number', direction: 'write', authority: 'UPSTREAM', description: 'Valor exato retornado pelo Pierre com sinal original', aliases: ['Valor Original', 'Valor Bruto', 'Valor Bruto Pierre'] },
      ...
      { domainField: 'rawCategory', notionProperty: 'Categoria Pierre', notionType: 'rich_text', direction: 'write', authority: 'UPSTREAM', description: 'Categoria bruta do open-finance', aliases: ['Categoria Original', 'Categoria Aberta', 'Categoria Pierre'] },
      { domainField: 'rawDescription', notionProperty: 'Descrição Original', notionType: 'rich_text', direction: 'write', authority: 'UPSTREAM', description: 'Texto original do extrato', aliases: ['Descrição Bruta', 'Descricao Banco', 'Descrição Original'] },
  ...
  NOTION_DS_CATEGORIES: {
    ...
    properties: [
      ...
      { domainField: 'variability', notionProperty: 'Variabilidade', notionType: 'select', direction: 'both', authority: 'USUARIO', description: 'Fixa, Variável, Ocasional', aliases: ['Variabilidade da Despesa', 'Variabilidade da Conta', 'Frequência', 'Tipo de Custo', 'Variabilidade'], expectedOptions: ['Fixa', 'Variável', 'Ocasional'] },
      {
        ...
        aliases: ['Natureza Padrão Sugerida', 'Natureza', 'Natureza Padrão'],
  ...
  NOTION_DS_INVESTMENTS: {
    ...
    properties: [
      { domainField: 'assetName', notionProperty: 'Ativo', notionType: 'title', direction: 'both', authority: 'USUARIO', description: 'Nome do ativo ou produto financeiro', aliases: ['Nome do Ativo', 'Nome', 'Produto', 'Papel', 'Ativo'] },
      {
        ...
        direction: 'both',
        authority: 'USUARIO',
        description: 'Renda Fixa, Cripto, Ação, FII, ETF, Previdência Privada, Tesouro Direto (Caixa Reservado NÃO é classe de ativo)',
        aliases: ['Classe', 'Tipo de Ativo', 'Categoria', 'Classe do Ativo'],
        expectedOptions: ['Renda Fixa', 'Cripto', 'Ação', 'FII', 'ETF', 'Previdência Privada', 'Tesouro Direto', 'Outros'],
        optionMappings: {
          'FIIs': 'FII',
          'FII': 'FII',
          'Ações': 'Ação',
      ...
      { domainField: 'currentMarketValue', notionProperty: 'Valor de Mercado Atual', notionType: 'number', direction: 'both', authority: 'UPSTREAM', description: 'Posição a mercado: Cotação atual x quantidade', aliases: ['Valor atual', 'Valor Atual', 'Saldo Atual', 'Posição Atual', 'Valor de Mercado', 'Patrimônio Atual'] },
  ...
  NOTION_DS_INVESTMENT_MOVEMENTS: {
    ...
    properties: [
      ...
      { domainField: 'investmentRelation', notionProperty: 'Ativo Vinculado', notionType: 'relation', direction: 'both', authority: 'REGRA_AUTOMATICA', description: 'Relação com a posição do ativo', relationTargetEnvKey: 'NOTION_DS_INVESTMENTS', aliases: ['Ativo', 'Investimento Vinculado'] },
      {
        ...
        aliases: ['Tipo', 'Operação'],
        expectedOptions: ['Aporte de Capital', 'Resgate de Capital', 'Compra de Ativo', 'Venda de Ativo', 'Rendimento / Provento', 'Taxas e Impostos', 'Ajuste de Posição'],
        optionMappings: {
          ...
          'Taxas e Impostos': 'FEES_AND_TAXES',
          'Ajuste de Posição': 'POSITION_ADJUSTMENT',
        },
        allowExtraOptions: true,
      },
      { domainField: 'date', notionProperty: 'Data da Operação', notionType: 'date', direction: 'both', authority: 'UPSTREAM', description: 'Data da execução', aliases: ['Data', 'Data Operação'] },
      { domainField: 'grossAmount', notionProperty: 'Valor Bruto', notionType: 'number', direction: 'both', authority: 'UPSTREAM', description: 'Volume financeiro total', aliases: ['Valor Total', 'Montante'] },
      { domainField: 'netAmount', notionProperty: 'Valor Líquido', notionType: 'number', direction: 'both', authority: 'UPSTREAM', description: 'Valor líquido após custos', aliases: ['Valor Líquido Operação'] },
  ...
  NOTION_DS_SYNC_LOG: {
    ...
    properties: [
      { domainField: 'title', notionProperty: 'Execução', notionType: 'title', direction: 'write', authority: 'DERIVADO', description: 'Sync - YYYY-MM-DD HH:mm:ss', aliases: ['Execução Sync', 'Título'] },
      {
        ...
        direction: 'write',
        authority: 'DERIVADO',
        description: 'Sucesso, Sucesso Parcial (Parcial), Erro, Executando, Bloqueado por Concorrência',
        aliases: ['Resultado', 'Status Execução'],
        expectedOptions: ['Sucesso', 'Parcial', 'Sucesso Parcial', 'Erro', 'Executando', 'Bloqueado por Concorrência'],
        optionMappings: {
          'Sucesso': 'SUCCESS',
          ...
          'Erro': 'ERROR',
          'Executando': 'RUNNING',
          'Bloqueado por Concorrência': 'BLOCKED_CONCURRENCY',
        },
        allowExtraOptions: true,
      },
      {
        ...
        aliases: ['Fonte de Sincronização', 'Origem Sincronização', 'Source'],
