...
export const TARGET_CONTRACT: Record<string, DataSourceContract> = {
  ...
  NOTION_DS_RULES: {
    ...
    properties: [
      ...
      { domainField: 'matchAmountTolerance', notionProperty: 'Condição: Tolerância Valor', notionType: 'number', numberFormat: 'number', direction: 'both', authority: 'USUARIO', description: 'Tolerância aceitável em reais', aliases: ['Tolerância', 'Tolerancia', 'Margem de Valor', 'Tolerância Valor'] },
  ...
  NOTION_DS_FIXED_BILLS: {
    ...
    properties: [
      ...
      { domainField: 'toleranceAmount', notionProperty: 'Tolerância (R$)', notionType: 'number', numberFormat: 'number', direction: 'both', authority: 'USUARIO', description: 'Tolerância para conciliação automática', aliases: ['Tolerância de valor', 'Tolerância', 'Margem', 'Tolerância (R$)'] },
