...
export const TARGET_CONTRACT: Record<string, DataSourceContract> = {
  ...
  NOTION_DS_CARD_BILLS: {
    ...
    properties: [
      ...
      { domainField: 'closingDate', notionProperty: 'Data de Fechamento', notionType: 'date', direction: 'write', authority: 'UPSTREAM', description: 'Data de corte (balance_close_date ou configurada)', aliases: ['Fechamento', 'Data Corte'] },
      { domainField: 'dueDate', notionProperty: 'Data de Vencimento', notionType: 'date', direction: 'write', authority: 'UPSTREAM', description: 'Data de vencimento (balance_due_date)', aliases: ['Vencimento', 'Data Venc'] },
      { domainField: 'rawBillAmount', notionProperty: 'Valor da Fatura (Banco)', notionType: 'number', direction: 'write', authority: 'UPSTREAM', description: 'Valor total consolidado emitido pela instituição', aliases: ['Valor Fatura', 'Total Fatura'] },
