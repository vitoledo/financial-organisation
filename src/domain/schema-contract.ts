...
/**
 * Canonical percentage convention:
 * Numeric percentage on scale 0..100 with numberFormat 'number' (e.g. 25.5 represents 25.5%).
 * Aligns with Notion column names containing '(%)' (e.g. 'Taxa de Poupança (%)', 'Retorno Não Realizado (%)').
 */
export const PERCENTAGE_CONVENTION = 'SCALE_0_TO_100_NUMBER' as const;
...
export const TARGET_CONTRACT: Record<string, DataSourceContract> = {
  NOTION_DS_ACCOUNTS: {
    ...
    properties: [
      ...
      { domainField: 'balance', notionProperty: 'Saldo Atual', notionType: 'number', numberFormat: 'real', direction: 'write', authority: 'UPSTREAM', description: 'Saldo disponível em reais', aliases: ['Saldo', 'Saldo em Conta', 'Saldo Atual', 'Saldo atual'] },
      { domainField: 'contractedCreditLimit', notionProperty: 'Limite Contratado', notionType: 'number', numberFormat: 'real', direction: 'write', authority: 'UPSTREAM', description: 'Limite total concedido pelo banco (ex: R$ 2.400)', aliases: ['Limite', 'Limite Total', 'Limite Contratado', 'Limite contratado'] },
      { domainField: 'customizedCreditLimit', notionProperty: 'Limite Personalizado', notionType: 'number', numberFormat: 'real', direction: 'both', authority: 'USUARIO', description: 'Teto operacional ajustado pelo usuário no app (ex: R$ 400)', aliases: ['Teto Operacional', 'Limite Definido', 'Limite Personalizado', 'Limite personalizado'] },
      { domainField: 'availableCreditLimit', notionProperty: 'Limite Disponível', notionType: 'number', numberFormat: 'real', direction: 'write', authority: 'UPSTREAM', description: 'Limite de crédito livre no momento', aliases: ['Disponível', 'Limite Livre', 'Limite Disponível', 'Limite disponível'] },
      { domainField: 'usedOperationalLimit', notionProperty: 'Limite Operacional Usado', notionType: 'number', numberFormat: 'real', direction: 'write', authority: 'DERIVADO', description: 'customizedCreditLimit - availableCreditLimit', aliases: ['Limite Usado', 'Limite Operacional Usado'] },
      { domainField: 'rawUsedCreditLimit', notionProperty: 'Limite Usado da Fonte (Bruto)', notionType: 'number', numberFormat: 'real', direction: 'write', authority: 'UPSTREAM', description: 'Valor bruto reportado pela fonte para auditoria de inconsistência', aliases: ['Limite Usado (Pierre Bruto)', 'Limite Bruto Pierre', 'Limite Usado da Fonte (Bruto)'] },
      { domainField: 'closingDay', notionProperty: 'Dia de Fechamento', notionType: 'number', numberFormat: 'number', direction: 'both', authority: 'USUARIO', description: 'Dia do mês do corte da fatura', aliases: ['Dia Fechamento', 'Fechamento', 'Dia de Fechamento'] },
      { domainField: 'dueDay', notionProperty: 'Dia de Vencimento', notionType: 'number', numberFormat: 'number', direction: 'both', authority: 'USUARIO', description: 'Dia do mês do vencimento da fatura', aliases: ['Dia Vencimento', 'Vencimento', 'Dia de Vencimento'] },
  ...
  NOTION_DS_TRANSACTIONS: {
    ...
    properties: [
      ...
      { domainField: 'amount', notionProperty: 'Valor', notionType: 'number', numberFormat: 'real', direction: 'both', authority: 'UPSTREAM', description: 'Valor monetário absoluto (R$)', aliases: ['Valor Transação', 'Valor Liquido', 'Total', 'Quantia', 'Valor'] },
      { domainField: 'rawAmount', notionProperty: 'Valor Bruto da Fonte', notionType: 'number', numberFormat: 'real', direction: 'write', authority: 'UPSTREAM', description: 'Valor exato retornado pelo conector/banco com sinal original', aliases: ['Valor Original', 'Valor Bruto', 'Valor Bruto Pierre', 'Valor Bruto da Fonte'] },
      ...
      { domainField: 'savingsGoalContribution', notionProperty: 'Contribuição Meta Poupança', notionType: 'number', numberFormat: 'real', direction: 'write', authority: 'REGRA_AUTOMATICA', description: 'Valor que pontua na meta de poupança (ex: R$ 500 aporte)', aliases: ['Poupança', 'Aporte Poupança', 'Contribuicao Poupanca', 'Contribuição Meta Poupança'] },
  ...
  NOTION_DS_RULES: {
    ...
    properties: [
      ...
      { domainField: 'priority', notionProperty: 'Prioridade', notionType: 'number', numberFormat: 'number', direction: 'both', authority: 'USUARIO', description: 'Ordem de avaliação (1 = prioridade máxima)', aliases: ['Ordem', 'Prioridade de Execução', 'Prioridade'] },
      ...
      { domainField: 'matchExactAmount', notionProperty: 'Condição: Valor Exato', notionType: 'number', numberFormat: 'real', direction: 'both', authority: 'USUARIO', description: 'Valor monetário exato', aliases: ['Valor exato', 'Valor Exato', 'Valor'] },
      { domainField: 'matchAmountTolerance', notionProperty: 'Condição: Tolerância Valor', notionType: 'number', numberFormat: 'real', direction: 'both', authority: 'USUARIO', description: 'Tolerância aceitável em reais', aliases: ['Tolerância', 'Tolerancia', 'Margem de Valor', 'Tolerância Valor'] },
      { domainField: 'matchMinAmount', notionProperty: 'Condição: Valor Mínimo', notionType: 'number', numberFormat: 'real', direction: 'both', authority: 'USUARIO', description: 'Piso do valor', aliases: ['Valor mínimo', 'Valor Mínimo', 'Valor Minimo', 'Valor Mínimo (R$)'] },
      { domainField: 'matchMaxAmount', notionProperty: 'Condição: Valor Máximo', notionType: 'number', numberFormat: 'real', direction: 'both', authority: 'USUARIO', description: 'Teto do valor', aliases: ['Valor máximo', 'Valor Máximo', 'Valor Maximo', 'Valor Máximo (R$)'] },
      { domainField: 'matchMinDay', notionProperty: 'Condição: Dia Mês Início', notionType: 'number', numberFormat: 'number', direction: 'both', authority: 'USUARIO', description: 'Dia inicial do mês (1 a 31)', aliases: ['Dia mínimo', 'Dia Mínimo', 'Dia Minimo', 'Dia Início'] },
      { domainField: 'matchMaxDay', notionProperty: 'Condição: Dia Mês Fim', notionType: 'number', numberFormat: 'number', direction: 'both', authority: 'USUARIO', description: 'Dia final do mês (1 a 31)', aliases: ['Dia máximo', 'Dia Máximo', 'Dia Maximo', 'Dia Fim'] },
  ...
  NOTION_DS_FIXED_BILLS: {
    ...
    properties: [
      ...
      { domainField: 'expectedAmount', notionProperty: 'Valor Previsto', notionType: 'number', numberFormat: 'real', direction: 'both', authority: 'USUARIO', description: 'Valor esperado por competência', aliases: ['Valor esperado', 'Valor', 'Valor Mensal', 'Preço', 'Valor Previsto'] },
      { domainField: 'toleranceAmount', notionProperty: 'Tolerância (R$)', notionType: 'number', numberFormat: 'real', direction: 'both', authority: 'USUARIO', description: 'Tolerância para conciliação automática', aliases: ['Tolerância de valor', 'Tolerância', 'Margem', 'Tolerância (R$)'] },
      ...
      { domainField: 'dueDay', notionProperty: 'Dia de Vencimento', notionType: 'number', numberFormat: 'number', direction: 'both', authority: 'USUARIO', description: 'Dia do mês do vencimento (1 a 31)', aliases: ['Dia do vencimento', 'Dia de Vencimento', 'Vencimento', 'Dia Venc'] },
  ...
  NOTION_DS_MONTHLY_OBLIGATIONS: {
    ...
    properties: [
      ...
      { domainField: 'expectedAmount', notionProperty: 'Valor Previsto', notionType: 'number', numberFormat: 'real', direction: 'write', authority: 'DERIVADO', description: 'Valor esperado herdado da conta fixa', aliases: ['Valor previsto', 'Valor esperado', 'Valor Esperado', 'Valor Previsto'] },
      ...
      { domainField: 'paidAmount', notionProperty: 'Valor Pago', notionType: 'number', numberFormat: 'real', direction: 'both', authority: 'REGRA_AUTOMATICA', description: 'Valor efetivamente liquidado', aliases: ['Valor pago', 'Valor Efetivo', 'Valor Liquidado', 'Valor Pago'] },
  ...
  NOTION_DS_INVESTMENTS: {
    ...
    properties: [
      ...
      { domainField: 'quantity', notionProperty: 'Quantidade', notionType: 'number', numberFormat: 'number', direction: 'both', authority: 'USUARIO', description: 'Posição atual custodiada', aliases: ['Posição', 'Qtd', 'Cotas / Ações', 'Quantidade'] },
      { domainField: 'unitAveragePrice', notionProperty: 'Preço Médio Unitário (PMP)', notionType: 'number', numberFormat: 'real', direction: 'write', authority: 'DERIVADO', description: 'Preço médio ponderado unitário de aquisição', aliases: ['Preço Médio', 'PMP', 'PM', 'Preço de Aquisição', 'Preço Médio Unitário (PMP)'] },
      { domainField: 'totalCostBasis', notionProperty: 'Custo Base Total', notionType: 'number', numberFormat: 'real', direction: 'write', authority: 'DERIVADO', description: 'Montante total acumulado desembolsado nas compras (base de custo contábil)', aliases: ['Custo acumulado', 'Custo Acumulado', 'Custo Total', 'Total Investido', 'Custo Histórico', 'Custo Base Total'] },
      { domainField: 'currentMarketValue', notionProperty: 'Valor de Mercado Atual', notionType: 'number', numberFormat: 'real', direction: 'both', authority: 'UPSTREAM', description: 'Posição a mercado: Cotação atual x quantidade', aliases: ['Valor atual', 'Valor Atual', 'Saldo Atual', 'Posição Atual', 'Valor de Mercado', 'Patrimônio Atual', 'Valor de Mercado Atual'] },
      { domainField: 'unrealizedProfitLoss', notionProperty: 'Lucro / Prejuízo Não Realizado', notionType: 'number', numberFormat: 'real', direction: 'write', authority: 'DERIVADO', description: 'Valor de Mercado Atual - Custo Base Total', aliases: ['Lucro/Prejuízo', 'Rentabilidade (R$)', 'Resultado', 'Lucro / Prejuízo Não Realizado'] },
      { domainField: 'profitLossPercentage', notionProperty: 'Retorno Não Realizado (%)', notionType: 'number', numberFormat: 'number', direction: 'write', authority: 'DERIVADO', description: '((Valor de Mercado Atual - Custo Base Total) / Custo Base Total) * 100', aliases: ['Rentabilidade (%)', 'Retorno (%)', 'Retorno Não Realizado (%)'] },
  ...
  NOTION_DS_INVESTMENT_MOVEMENTS: {
    ...
    properties: [
      ...
      { domainField: 'grossAmount', notionProperty: 'Valor Bruto', notionType: 'number', numberFormat: 'real', direction: 'both', authority: 'UPSTREAM', description: 'Volume financeiro total', aliases: ['Valor', 'Valor Total', 'Montante', 'Valor Bruto'] },
      { domainField: 'netCashEffect', notionProperty: 'Impacto Líquido de Caixa', notionType: 'number', numberFormat: 'real', direction: 'both', authority: 'DERIVADO', description: 'Efeito líquido de caixa com sinal econômico direcional (compra = negativo, venda = positivo)', aliases: ['Valor Líquido', 'Valor Líquido Operação', 'Impacto Caixa', 'Impacto Líquido de Caixa'] },
      { domainField: 'quantity', notionProperty: 'Quantidade Negociada', notionType: 'number', numberFormat: 'number', direction: 'both', authority: 'USUARIO', description: 'Fração ou unidades transacionadas', aliases: ['Quantidade', 'Cotas', 'Quantidade Negociada'] },
      { domainField: 'unitPrice', notionProperty: 'Preço Unitário', notionType: 'number', numberFormat: 'real', direction: 'both', authority: 'DERIVADO', description: 'Preço médio da ordem', aliases: ['Preço unitário', 'Preço Unitário', 'Preço Médio Operação', 'Cotação'] },
  ...
  NOTION_DS_MONTHLY_BUDGET: {
    ...
    properties: [
      ...
      { domainField: 'netIncomePlanned', notionProperty: 'Renda Prevista', notionType: 'number', numberFormat: 'real', direction: 'both', authority: 'USUARIO', description: 'Meta de renda do mês', aliases: ['Renda planejada', 'Renda Alvo', 'Renda Estimada', 'Renda Prevista'] },
      { domainField: 'cardSpendBudget', notionProperty: 'Teto Mensal Cartão', notionType: 'number', numberFormat: 'real', direction: 'both', authority: 'USUARIO', description: 'Teto pessoal de compras no cartão (ex: R$ 400)', aliases: ['Teto pessoal de crédito', 'Teto Cartão', 'Limite Cartão', 'Teto Mensal Cartão'] },
      { domainField: 'savingsGoalPlanned', notionProperty: 'Meta de Poupança/Aporte', notionType: 'number', numberFormat: 'real', direction: 'both', authority: 'USUARIO', description: 'Meta de dinheiro a poupar no mês', aliases: ['Aporte planejado', 'Meta Poupança', 'Meta Aporte', 'Meta de Poupança/Aporte'] },
      { domainField: 'savingsRateTarget', notionProperty: 'Meta Taxa de Poupança (%)', notionType: 'number', numberFormat: 'number', direction: 'both', authority: 'USUARIO', description: 'Percentual alvo da renda líquida destinado a investimentos e reservas', aliases: ['Meta de poupança %', 'Taxa Poupança Alvo (%)', 'Meta Taxa de Poupança (%)'] },
      { domainField: 'realizedIncome', notionProperty: 'Receitas Realizadas', notionType: 'number', numberFormat: 'real', direction: 'write', authority: 'DERIVADO', description: 'Soma de transações OPERATING_REVENUE', aliases: ['Renda Realizada', 'Receitas Realizadas'] },
      { domainField: 'realizedExpenses', notionProperty: 'Despesas Realizadas', notionType: 'number', numberFormat: 'real', direction: 'write', authority: 'DERIVADO', description: 'Soma de transações OPERATING_EXPENSE', aliases: ['Despesas Realizadas'] },
      { domainField: 'realizedSavings', notionProperty: 'Poupança Realizada', notionType: 'number', numberFormat: 'real', direction: 'write', authority: 'DERIVADO', description: 'Soma de transações com savingsGoalContribution', aliases: ['Poupança Efetiva', 'Poupança Realizada'] },
      { domainField: 'cardSpendRealized', notionProperty: 'Compras Realizadas Cartão', notionType: 'number', numberFormat: 'real', direction: 'write', authority: 'DERIVADO', description: 'Soma de compras de cartão no mês', aliases: ['Gasto Cartão Realizado', 'Compras Realizadas Cartão'] },
    ],
  },
  ...
  NOTION_DS_FINANCIAL_GOALS: {
    ...
    properties: [
      ...
      { domainField: 'targetAmount', notionProperty: 'Valor Alvo', notionType: 'number', numberFormat: 'real', direction: 'both', authority: 'USUARIO', description: 'Montante financeiro desejado', aliases: ['Valor alvo', 'Valor da Meta', 'Total Alvo', 'Valor Alvo'] },
      { domainField: 'currentAmount', notionProperty: 'Valor Atual Acumulado', notionType: 'number', numberFormat: 'real', direction: 'write', authority: 'DERIVADO', description: 'Saldo alocado para a meta', aliases: ['Valor atual', 'Saldo Atual', 'Montante Acumulado', 'Valor Atual Acumulado'] },
      ...
      { domainField: 'plannedMonthlyContribution', notionProperty: 'Aporte Mensal Planejado', notionType: 'number', numberFormat: 'real', direction: 'both', authority: 'USUARIO', description: 'Aporte mensal planejado para a meta', aliases: ['Aporte mensal planejado', 'Aporte Planejado', 'Aporte Mensal Planejado'] },
  ...
  NOTION_DS_MONTHLY_CLOSINGS: {
    ...
    properties: [
      ...
      { domainField: 'initialNetWorth', notionProperty: 'Patrimônio Inicial', notionType: 'number', numberFormat: 'real', direction: 'write', authority: 'DERIVADO', description: 'Patrimônio líquido consolidado no início do mês', aliases: ['Patrimônio Inicial Consolidado', 'Patrimônio Inicial'] },
      { domainField: 'totalIncome', notionProperty: 'Renda Consolidada', notionType: 'number', numberFormat: 'real', direction: 'write', authority: 'DERIVADO', description: 'Total de receitas operacionais líquidas', aliases: ['Receitas', 'Total Receitas', 'Receita Líquida', 'Renda Consolidada'] },
      { domainField: 'totalExpenses', notionProperty: 'Despesas Consolidadas', notionType: 'number', numberFormat: 'real', direction: 'write', authority: 'DERIVADO', description: 'Total de despesas correntes de subsistência e consumo', aliases: ['Despesas', 'Total Despesas', 'Gastos Totais', 'Despesas Consolidadas'] },
      { domainField: 'essentialExpenses', notionProperty: 'Despesas Essenciais (Necessidades)', notionType: 'number', numberFormat: 'real', direction: 'write', authority: 'DERIVADO', description: 'Gastos essenciais de moradia, saúde, alimentação básica', aliases: ['Gastos Essenciais', 'Necessidades (50%)', 'Despesas Essenciais (Necessidades)'] },
      { domainField: 'discretionaryExpenses', notionProperty: 'Despesas Discricionárias (Desejos)', notionType: 'number', numberFormat: 'real', direction: 'write', authority: 'DERIVADO', description: 'Gastos de estilo de vida, lazer e compras', aliases: ['Gastos Discricionários', 'Desejos (30%)', 'Despesas Discricionárias (Desejos)'] },
      { domainField: 'operatingSurplus', notionProperty: 'Resultado do Mês (Sobra Operacional)', notionType: 'number', numberFormat: 'real', direction: 'write', authority: 'DERIVADO', description: 'Renda Consolidada - Despesas Consolidadas (fluxo de caixa operacional livre do mês antes de aportes)', aliases: ['Sobra Operacional', 'Superávit Operacional', 'Resultado do Mês (Sobra Operacional)'] },
      { domainField: 'savingsAndInvestments', notionProperty: 'Poupança / Aportes Realizados', notionType: 'number', numberFormat: 'real', direction: 'write', authority: 'DERIVADO', description: 'Total efetivamente poupado e transferido para investimentos no mês', aliases: ['Aportes', 'Poupança Realizada', 'Poupança / Aportes Realizados'] },
      { domainField: 'savingsRate', notionProperty: 'Taxa de Poupança (%)', notionType: 'number', numberFormat: 'number', direction: 'write', authority: 'DERIVADO', description: '(Poupança / Aportes Realizados / Renda Consolidada) * 100', aliases: ['Taxa de Poupança Efetiva (%)', 'Taxa de Poupança (%)'] },
      { domainField: 'unallocatedCashFlow', notionProperty: 'Fluxo Residual Não Alocado', notionType: 'number', numberFormat: 'real', direction: 'write', authority: 'DERIVADO', description: 'Sobra Operacional - Poupança/Aportes Realizados', aliases: ['Fluxo Residual', 'Fluxo Residual Não Alocado'] },
      { domainField: 'investmentYield', notionProperty: 'Rendimentos de Investimentos', notionType: 'number', numberFormat: 'real', direction: 'write', authority: 'DERIVADO', description: 'Rendimentos e dividendos auferidos no mês', aliases: ['Rendimentos', 'Dividendos e Juros', 'Rendimentos de Investimentos'] },
      { domainField: 'finalNetWorth', notionProperty: 'Patrimônio Líquido Final', notionType: 'number', numberFormat: 'real', direction: 'write', authority: 'DERIVADO', description: 'Saldo contas + investimentos - dívidas ao fechar o mês', aliases: ['Patrimônio final', 'Patrimônio Líquido Final Consolidado', 'Patrimônio Líquido Final'] },
      { domainField: 'netWorthChange', notionProperty: 'Variação Patrimonial', notionType: 'number', numberFormat: 'real', direction: 'write', authority: 'DERIVADO', description: 'Patrimônio Final - Patrimônio Inicial', aliases: ['Evolução Patrimonial', 'Delta Patrimônio', 'Variação Patrimonial'] },
      { domainField: 'fixedBillsPaidCount', notionProperty: 'Contas Fixas Pagas', notionType: 'number', numberFormat: 'number', direction: 'write', authority: 'DERIVADO', description: 'Contagem de obrigações fixas da competência com status Paga', aliases: ['Contas fixas pagas', 'Contas Fixas Liquidadas', 'Obrigações Pagas', 'Contas Fixas Pagas'] },
      { domainField: 'fixedBillsPendingCount', notionProperty: 'Contas Fixas Pendentes', notionType: 'number', numberFormat: 'number', direction: 'write', authority: 'DERIVADO', description: 'Contagem de obrigações fixas da competência ainda pendentes ou atrasadas', aliases: ['Contas fixas pendentes', 'Contas Fixas em Aberto', 'Obrigações Pendentes', 'Contas Fixas Pendentes'] },
      { domainField: 'itemsNeedingReviewCount', notionProperty: 'Itens para Revisão', notionType: 'number', numberFormat: 'number', direction: 'write', authority: 'DERIVADO', description: 'Contagem de transações ou lançamentos da competência aguardando revisão humana', aliases: ['Itens para revisão', 'Itens Pendentes Revisão', 'Transações em Revisão', 'Itens Para Revisão'] },
  ...
  NOTION_DS_SYNC_LOG: {
    ...
    properties: [
      ...
      { domainField: 'durationSeconds', notionProperty: 'Duração (s)', notionType: 'number', numberFormat: 'number', direction: 'write', authority: 'DERIVADO', description: 'Tempo total de processamento em segundos', aliases: ['Duração (segundos)', 'Tempo Total (s)', 'Duração (s)'] },
      { domainField: 'durationMs', notionProperty: 'Duração (ms)', notionType: 'number', numberFormat: 'number', direction: 'write', authority: 'DERIVADO', description: 'Tempo total de processamento em milissegundos', aliases: ['Tempo de Execução (ms)', 'Duração (ms)'] },
      { domainField: 'accountsSynced', notionProperty: 'Contas Processadas', notionType: 'number', numberFormat: 'number', direction: 'write', authority: 'DERIVADO', description: 'Quantidade de contas sincronizadas', aliases: ['Contas recebidas', 'Contas Sincronizadas', 'Contas Processadas'] },
      { domainField: 'transactionsReceived', notionProperty: 'Transações Recebidas', notionType: 'number', numberFormat: 'number', direction: 'write', authority: 'DERIVADO', description: 'Lançamentos retornados pelo Pierre', aliases: ['Transações recebidas', 'Lançamentos Recebidos', 'Transações Recebidas'] },
      { domainField: 'transactionsCreated', notionProperty: 'Transações Novas', notionType: 'number', numberFormat: 'number', direction: 'write', authority: 'DERIVADO', description: 'Novas páginas criadas', aliases: ['Transações novas', 'Novas Transações', 'Criadas', 'Transações Novas'] },
      { domainField: 'transactionsUpdated', notionProperty: 'Transações Atualizadas', notionType: 'number', numberFormat: 'number', direction: 'write', authority: 'DERIVADO', description: 'Páginas existentes com versionHash alterado', aliases: ['Transações atualizadas', 'Transações Modificadas', 'Atualizadas', 'Transações Atualizadas'] },
      { domainField: 'transactionsUnchanged', notionProperty: 'Transações Inalteradas', notionType: 'number', numberFormat: 'number', direction: 'write', authority: 'DERIVADO', description: 'Transações sem alteração ignoradas', aliases: ['Transações Iguais', 'Ignoradas', 'Transações Inalteradas'] },
      { domainField: 'errorsCount', notionProperty: 'Erros Encontrados', notionType: 'number', numberFormat: 'number', direction: 'write', authority: 'DERIVADO', description: 'Total de falhas ou exceções não fatais registradas durante o lote', aliases: ['Quantidade de Erros', 'Total Erros', 'Erros Encontrados'] },
      { domainField: 'installmentsReceived', notionProperty: 'Parcelas Recebidas', notionType: 'number', numberFormat: 'number', direction: 'write', authority: 'DERIVADO', description: 'Parcelamentos e faturas futuras identificadas', aliases: ['Parcelas recebidas', 'Faturas e Parcelas', 'Parcelas Recebidas'] },
      { domainField: 'reviewQueueCount', notionProperty: 'Enviadas para Revisão', notionType: 'number', numberFormat: 'number', direction: 'write', authority: 'DERIVADO', description: 'Transações marcadas como Pendente Revisão', aliases: ['Pendências de revisão', 'Fila de Revisão', 'Pendentes Revisão', 'Enviadas para Revisão'] },
      { domainField: 'obligationsReconciled', notionProperty: 'Obrigações Conciliadas', notionType: 'number', numberFormat: 'number', direction: 'write', authority: 'DERIVADO', description: 'Compromissos mensais liquidados com sucesso', aliases: ['Compromissos Conciliados', 'Obrigações Conciliadas'] },
  ...
  NOTION_DS_CARD_BILLS: {
    ...
    properties: [
      ...
      { domainField: 'officialClosedBillAmount', notionProperty: 'Valor da Fatura Fechada (Oficial)', notionType: 'number', numberFormat: 'real', direction: 'write', authority: 'UPSTREAM', description: 'Valor consolidado oficial emitido pelo banco após fechamento. Estritamente null enquanto fatura aberta.', aliases: ['Valor Oficial', 'Valor Fechado', 'Valor da Fatura (Banco)', 'Total Fatura'] },
      { domainField: 'estimatedOpenBillAmount', notionProperty: 'Valor Estimado da Fatura Aberta', notionType: 'number', numberFormat: 'real', direction: 'write', authority: 'DERIVADO', description: 'Projeção acumulada das compras correntes antes do corte', aliases: ['Valor Estimado', 'Estimativa Aberta'] },
      { domainField: 'purchasesTotal', notionProperty: 'Total de Compras no Ciclo', notionType: 'number', numberFormat: 'real', direction: 'write', authority: 'DERIVADO', description: 'Soma real das transações de compra dentro do ciclo corrente', aliases: ['Total Compras'] },
      { domainField: 'additionalComponentsAmount', notionProperty: 'Componentes Adicionais da Fatura', notionType: 'number', numberFormat: 'real', direction: 'write', authority: 'DERIVADO', description: 'Soma dos componentes adicionais identificados (parcelas anteriores não contabilizadas no ciclo, encargos, IOF, juros, créditos/estornos)', aliases: ['Componentes Adicionais', 'Outros Encargos'] },
      { domainField: 'unexplainedDiscrepancy', notionProperty: 'Divergência Não Explicada', notionType: 'number', numberFormat: 'real', direction: 'write', authority: 'DERIVADO', description: 'Discrepância residual caso os componentes adicionais conhecidos não expliquem a diferença', aliases: ['Divergência Residual'] },
      { domainField: 'paidAmount', notionProperty: 'Valor Pago', notionType: 'number', numberFormat: 'real', direction: 'both', authority: 'REGRA_AUTOMATICA', description: 'Valor total liquidado até o momento', aliases: ['Total Pago'] },
...
/**
 * Exact set of 51 properties across the 12 existing Data Sources that are homologated
 * to be missing in the Phase 0/Phase 1 physical Notion baseline and must be created via DDL.
 */
export const HOMOLOGATED_MISSING_PROPERTIES: ReadonlySet<string> = new Set([
  'NOTION_DS_ACCOUNTS.Limite Operacional Usado',
  'NOTION_DS_ACCOUNTS.Limite Usado da Fonte (Bruto)',
  'NOTION_DS_ACCOUNTS.Dia de Fechamento',
  'NOTION_DS_ACCOUNTS.Dia de Vencimento',
  'NOTION_DS_TRANSACTIONS.Hash Canônico',
  'NOTION_DS_TRANSACTIONS.Valor Bruto da Fonte',
  'NOTION_DS_TRANSACTIONS.Efeito Orçamentário',
  'NOTION_DS_TRANSACTIONS.Propósito de Alocação',
  'NOTION_DS_TRANSACTIONS.Contribuição Meta Poupança',
  'NOTION_DS_TRANSACTIONS.Conta Destino',
  'NOTION_DS_TRANSACTIONS.Fatura Vinculada',
  'NOTION_DS_TRANSACTIONS.Status de Revisão',
  'NOTION_DS_TRANSACTIONS.Motivo da Revisão',
  'NOTION_DS_TRANSACTIONS.HMAC Contraparte',
  'NOTION_DS_RULES.Atribuir: Efeito Orçamento',
  'NOTION_DS_RULES.Atribuir: Alocação',
  'NOTION_DS_RULES.Atribuir: Conta Destino',
  'NOTION_DS_FIXED_BILLS.Competência Âncora',
  'NOTION_DS_FIXED_BILLS.Última Competência Gerada',
  'NOTION_DS_FIXED_BILLS.Data de Início',
  'NOTION_DS_FIXED_BILLS.Data de Término',
  'NOTION_DS_INVESTMENTS.Custódia',
  'NOTION_DS_INVESTMENTS.Preço Médio Unitário (PMP)',
  'NOTION_DS_INVESTMENTS.Lucro / Prejuízo Não Realizado',
  'NOTION_DS_INVESTMENTS.Retorno Não Realizado (%)',
  'NOTION_DS_INVESTMENTS.Conta Vinculada',
  'NOTION_DS_INVESTMENT_MOVEMENTS.Impacto Líquido de Caixa',
  'NOTION_DS_INVESTMENT_MOVEMENTS.Conta Destino / Caixa',
  'NOTION_DS_MONTHLY_BUDGET.Receitas Realizadas',
  'NOTION_DS_MONTHLY_BUDGET.Despesas Realizadas',
  'NOTION_DS_MONTHLY_BUDGET.Poupança Realizada',
  'NOTION_DS_MONTHLY_BUDGET.Compras Realizadas Cartão',
  'NOTION_DS_MONTHLY_CLOSINGS.Status de Reconciliação',
  'NOTION_DS_MONTHLY_CLOSINGS.Patrimônio Inicial',
  'NOTION_DS_MONTHLY_CLOSINGS.Despesas Essenciais (Necessidades)',
  'NOTION_DS_MONTHLY_CLOSINGS.Despesas Discricionárias (Desejos)',
  'NOTION_DS_MONTHLY_CLOSINGS.Resultado do Mês (Sobra Operacional)',
  'NOTION_DS_MONTHLY_CLOSINGS.Taxa de Poupança (%)',
  'NOTION_DS_MONTHLY_CLOSINGS.Fluxo Residual Não Alocado',
  'NOTION_DS_MONTHLY_CLOSINGS.Rendimentos de Investimentos',
  'NOTION_DS_MONTHLY_CLOSINGS.Variação Patrimonial',
  'NOTION_DS_SYNC_LOG.Duração (s)',
  'NOTION_DS_SYNC_LOG.Duração (ms)',
  'NOTION_DS_SYNC_LOG.Transações Inalteradas',
  'NOTION_DS_SYNC_LOG.Erros Encontrados',
  'NOTION_DS_SYNC_LOG.Obrigações Conciliadas',
  'NOTION_DS_SYNC_LOG.ID da Execução (Run ID)',
  'NOTION_DS_SYNC_LOG.Código do Erro',
  'NOTION_DS_SYNC_LOG.Referência do Log Privado',
  'NOTION_DS_SYNC_LOG.Hash do Lote RAW',
  'NOTION_DS_SYNC_LOG.Versão do Worker / Commit',
]);
