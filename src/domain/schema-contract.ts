...
export const TARGET_CONTRACT: Record<string, DataSourceContract> = {
  ...
  NOTION_DS_TRANSACTIONS: {
    ...
    properties: [
      ...
      { domainField: 'currency', notionProperty: 'Moeda', notionType: 'select', direction: 'both', authority: 'UPSTREAM', description: 'Código da moeda da transação (ex: BRL, USD)', aliases: ['Moeda da Transação', 'Currency', 'Moeda'], expectedOptions: ['BRL', 'USD'], optionMappings: { 'BRL': 'BRL', 'USD': 'USD', 'Outra': 'OTHER' }, allowExtraOptions: true },
  ...
  NOTION_DS_CATEGORIES: {
    ...
    properties: [
      ...
      { domainField: 'variability', notionProperty: 'Variabilidade', notionType: 'select', direction: 'both', authority: 'USUARIO', description: 'Fixa, Variável', aliases: ['Variabilidade da Despesa', 'Variabilidade da Conta', 'Frequência', 'Tipo de Custo', 'Variabilidade'], expectedOptions: ['Fixa', 'Variável'], allowExtraOptions: true },
      {
  ...
  NOTION_DS_FIXED_BILLS: {
    ...
    properties: [
      ...
      { domainField: 'paymentMethod', notionProperty: 'Forma de Pagamento', notionType: 'select', direction: 'both', authority: 'USUARIO', description: 'Cartão de Crédito, Débito em Conta, Pix, Boleto', aliases: ['Forma de pagamento', 'Forma de Pagamento', 'Meio de Pagamento', 'Método Pagamento'], expectedOptions: ['Boleto', 'Pix', 'Cartão', 'Débito automático'], optionMappings: { 'Cartão': 'CREDIT_CARD', 'Cartão de Crédito': 'CREDIT_CARD', 'Débito': 'BANK_DEBIT', 'Débito em Conta': 'BANK_DEBIT', 'Débito automático': 'BANK_DEBIT', 'Pix': 'PIX', 'Boleto': 'BOLETO' }, allowExtraOptions: true },
  ...
  NOTION_DS_MONTHLY_OBLIGATIONS: {
    ...
    properties: [
      ...
      { domainField: 'origin', notionProperty: 'Origem', notionType: 'select', direction: 'both', authority: 'USUARIO', description: 'Origem do registro da obrigação (Automática, Manual)', aliases: ['Origem'], expectedOptions: ['Automática', 'Manual'], allowExtraOptions: true },
  ...
  NOTION_DS_INVESTMENTS: {
    ...
    properties: [
      { domainField: 'assetName', notionProperty: 'Ativo', notionType: 'title', direction: 'both', authority: 'USUARIO', description: 'Nome do ativo ou produto financeiro', aliases: ['Nome do Ativo', 'Nome', 'Produto', 'Papel', 'Ativo'] },
      {
        ...
        expectedOptions: ['Ações', 'Cripto', 'FIIs', 'Renda Fixa', 'ETFs', 'Outro'],
        optionMappings: {
          'Ações': 'Ação',
          'Ação': 'Ação',
          'Cripto': 'Cripto',
      ...
      { domainField: 'currency', notionProperty: 'Moeda', notionType: 'select', direction: 'both', authority: 'USUARIO', description: 'Código da moeda do ativo (BRL, USD)', aliases: ['Moeda do Ativo', 'Moeda', 'Currency'], expectedOptions: ['BRL', 'USD'], optionMappings: { 'BRL': 'BRL', 'USD': 'USD', 'Outra': 'OTHER' }, allowExtraOptions: true },
      ...
      { domainField: 'valuationSource', notionProperty: 'Fonte da Avaliação', notionType: 'select', direction: 'both', authority: 'USUARIO', description: 'Origem da cotação a mercado (ex: Pierre, Manual, Mercado, Outra)', aliases: ['Fonte do preço', 'Fonte do Preço', 'Fonte Avaliação', 'Fonte Cotação', 'Fonte da Avaliação'], expectedOptions: ['Pierre', 'Manual'], optionMappings: { 'Pierre': 'PIERRE', 'Manual': 'MANUAL', 'Mercado': 'MARKET', 'Outra': 'OTHER' }, allowExtraOptions: true },
  ...
  NOTION_DS_FINANCIAL_GOALS: {
    ...
    properties: [
      ...
      { domainField: 'goalType', notionProperty: 'Tipo', notionType: 'select', direction: 'both', authority: 'USUARIO', description: 'Classificação da meta (Aposentadoria, Viagem, Reserva, Patrimônio, Outro)', aliases: ['Tipo de Meta', 'Categoria Meta', 'Tipo'], expectedOptions: ['Aposentadoria', 'Viagem', 'Reserva', 'Patrimônio', 'Outro'], allowExtraOptions: true },
      { domainField: 'requiredLiquidity', notionProperty: 'Liquidez Necessária', notionType: 'select', direction: 'both', authority: 'USUARIO', description: 'Prazo/perfil de liquidez necessária para a meta', aliases: ['Liquidez necessária', 'Liquidez', 'Liquidez Necessária'], expectedOptions: ['Imediata', 'Curto Prazo', 'Médio Prazo', 'Longo Prazo'], allowExtraOptions: true },
      ...
      { domainField: 'status', notionProperty: 'Status', notionType: 'select', direction: 'both', authority: 'USUARIO', description: 'Andamento da meta (Não iniciada, Em andamento, Concluída)', aliases: ['Status Meta', 'Situação', 'Status'], expectedOptions: ['Não iniciada', 'Em andamento', 'Concluída'], allowExtraOptions: true },
