...
export const TARGET_CONTRACT: Record<string, DataSourceContract> = {
  ...
  NOTION_DS_MONTHLY_OBLIGATIONS: {
    ...
    properties: [
      ...
      { domainField: 'competencePeriod', notionProperty: 'Competência', notionType: 'rich_text', direction: 'both', authority: 'DERIVADO', description: 'Mês de referência (YYYY-MM)', aliases: ['Mês', 'Competência Referência', 'Competência'] },
  ...
  NOTION_DS_SYNC_LOG: {
    ...
    properties: [
      ...
      },
      {
        ...
        direction: 'write',
        authority: 'DERIVADO',
        description: 'Sistema ou conector de origem da sincronização (ex: Pierre, Manual, Migração, Outra)',
