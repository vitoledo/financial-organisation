...
export const TARGET_CONTRACT: Record<string, DataSourceContract> = {
  NOTION_DS_ACCOUNTS: {
    ...
    isExisting: true,
    properties: [
      { domainField: 'name', notionProperty: 'Nome da Conta', notionType: 'title', direction: 'both', authority: 'PIERRE', description: 'Nome identificador da conta', aliases: ['Nome', 'Conta', 'Nome Conta'] },
      { domainField: 'id', notionProperty: 'ID Pierre', notionType: 'rich_text', direction: 'both', authority: 'PIERRE', description: 'UUID da conta no Pierre Finance', aliases: ['ID', 'UUID', 'Pierre ID'] },
      { domainField: 'institution', notionProperty: 'Instituição', notionType: 'select', direction: 'both', authority: 'PIERRE', description: 'Nome do banco / conector (ex: Nubank, Mercado Pago)', aliases: ['Banco', 'Instituicao'] },
      { domainField: 'type', notionProperty: 'Tipo de Conta', notionType: 'select', direction: 'both', authority: 'PIERRE', description: 'CHECKING_ACCOUNT, CREDIT_CARD, SAVINGS', aliases: ['Tipo', 'Tipo Conta'] },
      { domainField: 'balance', notionProperty: 'Saldo Atual', notionType: 'number', direction: 'write', authority: 'PIERRE', description: 'Saldo disponível em reais', aliases: ['Saldo', 'Saldo em Conta'] },
      { domainField: 'contractedCreditLimit', notionProperty: 'Limite Contratado', notionType: 'number', direction: 'write', authority: 'PIERRE', description: 'Limite total concedido pelo banco (ex: R$ 2.400)', aliases: ['Limite', 'Limite Total'] },
      { domainField: 'customizedCreditLimit', notionProperty: 'Limite Personalizado', notionType: 'number', direction: 'both', authority: 'USUARIO', description: 'Teto operacional ajustado pelo usuário no app (ex: R$ 400)', aliases: ['Teto Operacional', 'Limite Definido'] },
      { domainField: 'availableCreditLimit', notionProperty: 'Limite Disponível', notionType: 'number', direction: 'write', authority: 'PIERRE', description: 'Limite de crédito livre no momento', aliases: ['Disponível', 'Limite Livre'] },
      { domainField: 'usedOperationalLimit', notionProperty: 'Limite Operacional Usado', notionType: 'number', direction: 'write', authority: 'DERIVADO', description: 'customizedCreditLimit - availableCreditLimit', aliases: ['Limite Usado'] },
      { domainField: 'rawUsedCreditLimit', notionProperty: 'Limite Usado (Pierre Bruto)', notionType: 'number', direction: 'write', authority: 'PIERRE', description: 'Valor bruto reportado pelo Pierre para auditoria de inconsistência', aliases: ['Limite Bruto Pierre'] },
      { domainField: 'closingDay', notionProperty: 'Dia de Fechamento', notionType: 'number', direction: 'both', authority: 'USUARIO', description: 'Dia do mês do corte da fatura', aliases: ['Dia Fechamento', 'Fechamento'] },
      { domainField: 'dueDay', notionProperty: 'Dia de Vencimento', notionType: 'number', direction: 'both', authority: 'USUARIO', description: 'Dia do mês do vencimento da fatura', aliases: ['Dia Vencimento', 'Vencimento'] },
      { domainField: 'includeInCash', notionProperty: 'Incluir no Caixa', notionType: 'checkbox', direction: 'both', authority: 'USUARIO', description: 'Indica se computa para liquidez imediata', aliases: ['Caixa', 'Compor Caixa'] },
      { domainField: 'includeInNetWorth', notionProperty: 'Incluir no Patrimônio', notionType: 'checkbox', direction: 'both', authority: 'USUARIO', description: 'Indica se computa para o patrimônio total', aliases: ['Patrimônio', 'Compor Patrimônio'] },
      { domainField: 'lastSyncedAt', notionProperty: 'Última Sincronização', notionType: 'date', direction: 'write', authority: 'DERIVADO', description: 'Timestamp da sincronização', aliases: ['Último Sync', 'Data Sync'] },
    ],
  },
  ...
  NOTION_DS_TRANSACTIONS: {
    ...
    isExisting: true,
    properties: [
      { domainField: 'description', notionProperty: 'Descrição', notionType: 'title', direction: 'both', authority: 'REGRA_AUTOMATICA', description: 'Descrição tratada da transação', aliases: ['Descricao', 'Nome', 'Título', 'Titulo', 'Lancamento'] },
      { domainField: 'id', notionProperty: 'ID Pierre', notionType: 'rich_text', direction: 'both', authority: 'PIERRE', description: 'UUID unívoco da transação no Pierre', aliases: ['ID', 'UUID', 'Pierre ID'] },
      { domainField: 'canonicalHash', notionProperty: 'Hash Canônico', notionType: 'rich_text', direction: 'both', authority: 'DERIVADO', description: 'Fingerprint SHA-256 (64 chars) de versão', aliases: ['Hash', 'Fingerprint', 'Version Hash'] },
      { domainField: 'date', notionProperty: 'Data', notionType: 'date', direction: 'both', authority: 'PIERRE', description: 'Data da transação (ISO-8601)', aliases: ['Data Transacao', 'Data da Operação', 'Data Operação'] },
      { domainField: 'amount', notionProperty: 'Valor', notionType: 'number', direction: 'both', authority: 'PIERRE', description: 'Valor monetário absoluto (R$)', aliases: ['Valor Transação', 'Valor Liquido', 'Total', 'Quantia'] },
      { domainField: 'rawAmount', notionProperty: 'Valor Bruto Pierre', notionType: 'number', direction: 'write', authority: 'PIERRE', description: 'Valor exato retornado pelo Pierre com sinal original', aliases: ['Valor Original', 'Valor Bruto'] },
      { domainField: 'flowDirection', notionProperty: 'Movimento', notionType: 'select', direction: 'both', authority: 'PIERRE', description: 'Entrada ou Saída de caixa físico', aliases: ['Tipo', 'Direção', 'Direcao', 'Sentido', 'Fluxo'] },
      { domainField: 'economicNature', notionProperty: 'Natureza Econômica', notionType: 'select', direction: 'both', authority: 'REGRA_AUTOMATICA', description: 'Classificação contábil da operação', aliases: ['Natureza', 'Classificação Contábil', 'Classificacao'] },
      { domainField: 'budgetEffect', notionProperty: 'Efeito Orçamentário', notionType: 'select', direction: 'both', authority: 'REGRA_AUTOMATICA', description: 'INCOME | EXPENSE | REVERSAL | NEUTRAL', aliases: ['Efeito Orçamento', 'Impacto Orçamentário', 'Impacto Orcamentario'] },
      { domainField: 'allocationPurpose', notionProperty: 'Propósito de Alocação', notionType: 'select', direction: 'both', authority: 'REGRA_AUTOMATICA', description: 'INVESTMENT_RESERVE | OPERATIONAL_CASH | etc.', aliases: ['Propósito', 'Proposito', 'Finalidade', 'Alocação', 'Alocacao'] },
      { domainField: 'savingsGoalContribution', notionProperty: 'Contribuição Meta Poupança', notionType: 'number', direction: 'write', authority: 'REGRA_AUTOMATICA', description: 'Valor que pontua na meta de poupança (ex: R$ 500 aporte)', aliases: ['Poupança', 'Aporte Poupança', 'Contribuicao Poupanca'] },
      { domainField: 'accountRelation', notionProperty: 'Conta', notionType: 'relation', direction: 'write', authority: 'DERIVADO', description: 'Relação com base Contas', aliases: ['Conta Bancária', 'Conta Origem'] },
      { domainField: 'categoryRelation', notionProperty: 'Categoria', notionType: 'relation', direction: 'both', authority: 'REGRA_AUTOMATICA', description: 'Relação com Categorias Financeiras', aliases: ['Categoria Financeira'] },
      { domainField: 'billRelation', notionProperty: 'Fatura Vinculada', notionType: 'relation', direction: 'write', authority: 'DERIVADO', description: 'Relação com 13ª base Faturas / Ciclos', aliases: ['Fatura', 'Ciclo Fatura'] },
      { domainField: 'status', notionProperty: 'Status Banco', notionType: 'select', direction: 'write', authority: 'PIERRE', description: 'Pendente ou Confirmado', aliases: ['Status', 'Status Transação'] },
      { domainField: 'reviewStatus', notionProperty: 'Status de Revisão', notionType: 'select', direction: 'both', authority: 'REGRA_AUTOMATICA', description: 'Confirmado Auto, Pendente Revisão, Validado Manualmente, Legado Não Verificado', aliases: ['Revisão', 'Status Revisão', 'Revisao'] },
      { domainField: 'reviewReason', notionProperty: 'Motivo da Revisão', notionType: 'rich_text', direction: 'write', authority: 'REGRA_AUTOMATICA', description: 'Justificativa para intervenção humana', aliases: ['Motivo Revisão', 'Razão Revisão', 'Justificativa'] },
      { domainField: 'rawCategory', notionProperty: 'Categoria Pierre', notionType: 'rich_text', direction: 'write', authority: 'PIERRE', description: 'Categoria bruta do open-finance', aliases: ['Categoria Original', 'Categoria Aberta'] },
      { domainField: 'rawDescription', notionProperty: 'Descrição Original', notionType: 'rich_text', direction: 'write', authority: 'PIERRE', description: 'Texto original do extrato', aliases: ['Descrição Bruta', 'Descricao Banco'] },
      { domainField: 'counterpartyHmac', notionProperty: 'HMAC Contraparte', notionType: 'rich_text', direction: 'write', authority: 'DERIVADO', description: 'Hash seguro do CPF/CNPJ para matching sem expor PII', aliases: ['Hash Contraparte', 'HMAC'] },
    ],
  },
  ...
  NOTION_DS_CATEGORIES: {
    ...
    isExisting: true,
    properties: [
      { domainField: 'name', notionProperty: 'Nome da Categoria', notionType: 'title', direction: 'both', authority: 'USUARIO', description: 'Nome da categoria', aliases: ['Categoria', 'Nome', 'Título'] },
      { domainField: 'budgetGroup', notionProperty: 'Grupo Orçamentário', notionType: 'select', direction: 'both', authority: 'USUARIO', description: 'Agrupamento macro orçamentário configurável (ex: Essencial, Estilo de Vida, Metas, Estrutural)', aliases: ['Grupo 50/30/20', 'Grupo', 'Grupo Orçamento', 'Agrupamento'] },
      { domainField: 'variability', notionProperty: 'Variabilidade', notionType: 'select', direction: 'both', authority: 'USUARIO', description: 'Fixa, Variável, Ocasional', aliases: ['Variabilidade da Despesa', 'Variabilidade da Conta', 'Frequência', 'Tipo de Custo'] },
      { domainField: 'defaultNature', notionProperty: 'Natureza Padrão', notionType: 'select', direction: 'both', authority: 'USUARIO', description: 'Natureza contábil sugerida', aliases: ['Natureza Padrão Sugerida', 'Natureza'] },
    ],
  },
  ...
  NOTION_DS_RULES: {
    ...
    isExisting: true,
    properties: [
      { domainField: 'name', notionProperty: 'Nome da Regra', notionType: 'title', direction: 'both', authority: 'USUARIO', description: 'Título descritivo da regra', aliases: ['Regra', 'Nome'] },
      { domainField: 'priority', notionProperty: 'Prioridade', notionType: 'number', direction: 'both', authority: 'USUARIO', description: 'Ordem de avaliação (1 = prioridade máxima)', aliases: ['Ordem', 'Prioridade de Execução'] },
      { domainField: 'isActive', notionProperty: 'Ativa', notionType: 'checkbox', direction: 'both', authority: 'USUARIO', description: 'Liga/desliga a regra', aliases: ['Ativo', 'Habilitada'] },
      { domainField: 'autoApply', notionProperty: 'Auto Aplicar', notionType: 'checkbox', direction: 'both', authority: 'USUARIO', description: 'Se falso, obriga envio para revisão', aliases: ['Aplicar Automaticamente', 'Auto'] },
      { domainField: 'requireReview', notionProperty: 'Exigir Revisão', notionType: 'checkbox', direction: 'both', authority: 'USUARIO', description: 'Se verdadeiro, marca para checagem humana', aliases: ['Sinalizar para Revisão', 'Revisar'] },
      { domainField: 'matchCounterparty', notionProperty: 'Condição: Contraparte', notionType: 'rich_text', direction: 'both', authority: 'USUARIO', description: 'Substring ou nome do merchant/destinatário', aliases: ['Contraparte', 'Merchant', 'Estabelecimento'] },
      { domainField: 'matchDescription', notionProperty: 'Condição: Descrição', notionType: 'rich_text', direction: 'both', authority: 'USUARIO', description: 'Substring ou regex na descrição', aliases: ['Padrão de Descrição', 'Texto Descrição'] },
      { domainField: 'matchDirection', notionProperty: 'Condição: Movimento', notionType: 'select', direction: 'both', authority: 'USUARIO', description: 'Qualquer, Entrada, Saída', aliases: ['Sentido', 'Direção'] },
      { domainField: 'matchAccountRelation', notionProperty: 'Condição: Conta', notionType: 'relation', direction: 'both', authority: 'USUARIO', description: 'Conta de origem específica', aliases: ['Conta Aplicável'] },
      { domainField: 'matchRawCategory', notionProperty: 'Condição: Categoria Pierre', notionType: 'rich_text', direction: 'both', authority: 'USUARIO', description: 'Categoria original Pierre', aliases: ['Categoria Banco'] },
      { domainField: 'matchExactAmount', notionProperty: 'Condição: Valor Exato', notionType: 'number', direction: 'both', authority: 'USUARIO', description: 'Valor monetário exato', aliases: ['Valor'] },
      { domainField: 'matchAmountTolerance', notionProperty: 'Condição: Tolerância Valor', notionType: 'number', direction: 'both', authority: 'USUARIO', description: 'Tolerância aceitável em reais', aliases: ['Margem de Valor'] },
      { domainField: 'matchMinAmount', notionProperty: 'Condição: Valor Mínimo', notionType: 'number', direction: 'both', authority: 'USUARIO', description: 'Piso do valor', aliases: ['Valor Mínimo (R$)'] },
      { domainField: 'matchMaxAmount', notionProperty: 'Condição: Valor Máximo', notionType: 'number', direction: 'both', authority: 'USUARIO', description: 'Teto do valor', aliases: ['Valor Máximo (R$)'] },
      { domainField: 'matchMinDay', notionProperty: 'Condição: Dia Mês Início', notionType: 'number', direction: 'both', authority: 'USUARIO', description: 'Dia inicial do mês (1 a 31)', aliases: ['Dia Início'] },
      { domainField: 'matchMaxDay', notionProperty: 'Condição: Dia Mês Fim', notionType: 'number', direction: 'both', authority: 'USUARIO', description: 'Dia final do mês (1 a 31)', aliases: ['Dia Fim'] },
      { domainField: 'validityPeriod', notionProperty: 'Período de Validade', notionType: 'date', direction: 'both', authority: 'USUARIO', description: 'Vigência temporal da regra', aliases: ['Validade'] },
      { domainField: 'assignNature', notionProperty: 'Atribuir: Natureza', notionType: 'select', direction: 'both', authority: 'USUARIO', description: 'Natureza atribuída', aliases: ['Natureza Contábil'] },
      { domainField: 'assignBudgetEffect', notionProperty: 'Atribuir: Efeito Orçamento', notionType: 'select', direction: 'both', authority: 'USUARIO', description: 'INCOME, EXPENSE, REVERSAL, NEUTRAL', aliases: ['Efeito Orçamento Atribuído'] },
      { domainField: 'assignAllocationPurpose', notionProperty: 'Atribuir: Alocação', notionType: 'select', direction: 'both', authority: 'USUARIO', description: 'Finalidade da movimentação', aliases: ['Finalidade Alocação'] },
      { domainField: 'assignCategory', notionProperty: 'Atribuir: Categoria', notionType: 'relation', direction: 'both', authority: 'USUARIO', description: 'Categoria vinculada', aliases: ['Categoria Atribuída'] },
    ],
  },
  ...
  NOTION_DS_FIXED_BILLS: {
    ...
    properties: [
      ...
      { domainField: 'periodicity', notionProperty: 'Periodicidade', notionType: 'select', direction: 'both', authority: 'USUARIO', description: 'Mensal, Bimestral, Trimestral, Semestral, Anual', aliases: ['Frequência', 'Recorrência'] },
      ...
      { domainField: 'paymentMethod', notionProperty: 'Forma de Pagamento', notionType: 'select', direction: 'both', authority: 'USUARIO', description: 'Cartão de Crédito, Débito em Conta, Pix, Boleto', aliases: ['Meio de Pagamento', 'Método Pagamento'] },
      { domainField: 'defaultAccount', notionProperty: 'Conta Padrão', notionType: 'relation', direction: 'both', authority: 'USUARIO', description: 'Conta de débito usual', aliases: ['Conta', 'Conta Débito'] },
      { domainField: 'category', notionProperty: 'Categoria', notionType: 'relation', direction: 'both', authority: 'USUARIO', description: 'Categoria orçamentária', aliases: ['Categoria Despesa'] },
  ...
  NOTION_DS_MONTHLY_OBLIGATIONS: {
    ...
    properties: [
      ...
      { domainField: 'fixedBillRelation', notionProperty: 'Conta Fixa', notionType: 'relation', direction: 'write', authority: 'DERIVADO', description: 'Relação com o cadastro permanente', aliases: ['Conta Fixa Origem', 'Contrato'] },
      ...
      { domainField: 'status', notionProperty: 'Status', notionType: 'select', direction: 'both', authority: 'REGRA_AUTOMATICA', description: 'Prevista, Paga, Atrasada, Revisão Necessária, Cancelada', aliases: ['Status Pagamento', 'Situação'] },
      ...
      { domainField: 'matchedTransaction', notionProperty: 'Transação Vinculada', notionType: 'relation', direction: 'both', authority: 'REGRA_AUTOMATICA', description: 'Relação com a transação que liquidou', aliases: ['Transação', 'Comprovante'] },
  ...
  NOTION_DS_INVESTMENTS: {
    ...
    isExisting: true,
    properties: [
      { domainField: 'assetName', notionProperty: 'Ativo', notionType: 'title', direction: 'both', authority: 'USUARIO', description: 'Nome do ativo ou produto financeiro', aliases: ['Nome do Ativo', 'Nome', 'Produto', 'Papel'] },
      { domainField: 'assetType', notionProperty: 'Classe do Ativo', notionType: 'select', direction: 'both', authority: 'USUARIO', description: 'Renda Fixa, Cripto, Ação, FII, ETF, Previdência Privada, Tesouro Direto (Caixa Reservado NÃO é classe de ativo)', aliases: ['Tipo de Ativo', 'Classe', 'Categoria'] },
      { domainField: 'origin', notionProperty: 'Custódia', notionType: 'select', direction: 'both', authority: 'USUARIO', description: 'Conta Pierre ou Carteira Externa', aliases: ['Origem', 'Instituição Custódia'] },
      { domainField: 'currency', notionProperty: 'Moeda', notionType: 'select', direction: 'both', authority: 'USUARIO', description: 'Código da moeda do ativo (BRL, USD, BTC, EUR)', aliases: ['Moeda do Ativo'] },
      { domainField: 'quantity', notionProperty: 'Quantidade', notionType: 'number', direction: 'both', authority: 'USUARIO', description: 'Posição atual custodiada', aliases: ['Posição', 'Qtd', 'Cotas / Ações'] },
      ...
      { domainField: 'totalCostBasis', notionProperty: 'Custo Base Total', notionType: 'number', direction: 'write', authority: 'DERIVADO', description: 'Montante total acumulado desembolsado nas compras (base de custo contábil)', aliases: ['Custo Total', 'Total Investido', 'Custo Histórico'] },
      { domainField: 'currentMarketValue', notionProperty: 'Valor de Mercado Atual', notionType: 'number', direction: 'both', authority: 'PIERRE', description: 'Posição a mercado: Cotação atual x quantidade', aliases: ['Saldo Atual', 'Posição Atual', 'Valor de Mercado', 'Patrimônio Atual'] },
      ...
      { domainField: 'liquidity', notionProperty: 'Liquidez', notionType: 'select', direction: 'both', authority: 'USUARIO', description: 'Prazo de liquidez (ex: D+0, D+1, D+30, No Vencimento)', aliases: ['Prazo Liquidez', 'Liquidez Resgate'] },
      { domainField: 'valuationSource', notionProperty: 'Fonte da Avaliação', notionType: 'select', direction: 'both', authority: 'USUARIO', description: 'Origem da cotação a mercado (ex: Pierre, B3, Manual, Cripto API)', aliases: ['Fonte Avaliação', 'Fonte Cotação'] },
      { domainField: 'valuationDate', notionProperty: 'Data da Avaliação', notionType: 'date', direction: 'both', authority: 'DERIVADO', description: 'Data/hora da última cotação de mercado capturada', aliases: ['Data Avaliação', 'Última Cotação'] },
      { domainField: 'includeInNetWorth', notionProperty: 'Incluir no Patrimônio', notionType: 'checkbox', direction: 'both', authority: 'USUARIO', description: 'Indica se esta posição deve compor o cálculo de patrimônio líquido final', aliases: ['Incluir Patrimônio', 'Compor Patrimônio', 'Patrimônio Líquido'] },
      { domainField: 'institution', notionProperty: 'Instituição / Corretora', notionType: 'select', direction: 'both', authority: 'USUARIO', description: 'Corretora ou custodiante do investimento (ex: NuInvest, Binance, XP, BTG)', aliases: ['Instituição', 'Corretora', 'Custodiante'] },
      { domainField: 'sourceAssetId', notionProperty: 'ID do Ativo na Fonte', notionType: 'rich_text', direction: 'both', authority: 'PIERRE', description: 'Identificador único do ativo na API de origem para sincronização', aliases: ['ID Fonte', 'Asset ID', 'Código do Ativo'] },
      { domainField: 'linkedAccount', notionProperty: 'Conta Vinculada', notionType: 'relation', direction: 'both', authority: 'USUARIO', description: 'Conta corrente ou corretora associada', aliases: ['Conta Corretora', 'Conta'] },
    ],
  },
  ...
  NOTION_DS_INVESTMENT_MOVEMENTS: {
    ...
    properties: [
      ...
      { domainField: 'investmentRelation', notionProperty: 'Ativo Vinculado', notionType: 'relation', direction: 'both', authority: 'REGRA_AUTOMATICA', description: 'Relação com a posição do ativo', aliases: ['Ativo', 'Investimento Vinculado'] },
      { domainField: 'movementType', notionProperty: 'Tipo de Movimentação', notionType: 'select', direction: 'both', authority: 'REGRA_AUTOMATICA', description: 'Aporte de Capital, Resgate de Capital, Compra de Ativo, Venda de Ativo, Rendimento / Provento, Taxas e Impostos, Ajuste de Posição', aliases: ['Tipo', 'Operação'] },
      ...
      { domainField: 'sourceAccount', notionProperty: 'Conta Origem', notionType: 'relation', direction: 'write', authority: 'DERIVADO', description: 'Conta debitada', aliases: ['Conta Débito', 'Origem'] },
      { domainField: 'destinationAccount', notionProperty: 'Conta Destino / Caixa', notionType: 'relation', direction: 'write', authority: 'DERIVADO', description: 'Conta creditada', aliases: ['Conta Crédito', 'Destino'] },
      { domainField: 'relatedTransaction', notionProperty: 'Transação Financeira', notionType: 'relation', direction: 'write', authority: 'DERIVADO', description: 'Transação bancária vinculada', aliases: ['Transação Bancária'] },
    ],
  },
  ...
  NOTION_DS_MONTHLY_CLOSINGS: {
    ...
    properties: [
      ...
      { domainField: 'status', notionProperty: 'Status do Fechamento', notionType: 'select', direction: 'both', authority: 'USUARIO', description: 'Aberto, Pré-fechado, Fechado Auditado', aliases: ['Status', 'Situação'] },
      { domainField: 'reconciliationStatus', notionProperty: 'Status de Reconciliação', notionType: 'select', direction: 'both', authority: 'REGRA_AUTOMATICA', description: 'Conciliado Integralmente, Divergências Pendentes, Reconciliação Manual Necessária', aliases: ['Status Reconciliação', 'Reconciliação'] },
      { domainField: 'dataQualityScore', notionProperty: 'Qualidade dos Dados', notionType: 'select', direction: 'both', authority: 'REGRA_AUTOMATICA', description: 'Nota ou classificação da confiabilidade dos lançamentos do mês', aliases: ['Qualidade Dados', 'Confiabilidade Dados'] },
  ...
  NOTION_DS_SYNC_LOG: {
    ...
    properties: [
      ...
      { domainField: 'status', notionProperty: 'Status', notionType: 'select', direction: 'write', authority: 'DERIVADO', description: 'Sucesso, Sucesso Parcial, Erro, Bloqueado por Concorrência', aliases: ['Resultado', 'Status Execução'] },
      { domainField: 'syncSource', notionProperty: 'Fonte de Sincronização', notionType: 'select', direction: 'write', authority: 'DERIVADO', description: 'Sistema ou conector de origem da sincronização (ex: PIERRE, MANUAL_CSV, MIGRATION)', aliases: ['Fonte', 'Origem Sincronização', 'Source'] },
  ...
  NOTION_DS_CARD_BILLS: {
    ...
    properties: [
      ...
      { domainField: 'accountRelation', notionProperty: 'Cartão Vinculado', notionType: 'relation', direction: 'write', authority: 'DERIVADO', description: 'Relação com a conta do cartão em Contas', aliases: ['Cartão', 'Conta Cartão'] },
      { domainField: 'cycleType', notionProperty: 'Tipo de Ciclo', notionType: 'select', direction: 'write', authority: 'DERIVADO', description: 'Ciclo Real Banco, Ciclo Configurado, Ciclo Estimado', aliases: ['Tipo Ciclo'] },
      { domainField: 'status', notionProperty: 'Status da Fatura', notionType: 'select', direction: 'both', authority: 'REGRA_AUTOMATICA', description: 'Aberta em Curso, Fechada a Vencer, Vencida, Paga Integralmente, Paga Parcialmente', aliases: ['Status Fatura', 'Situação'] },
      ...
      { domainField: 'transactionsRelation', notionProperty: 'Lançamentos do Ciclo', notionType: 'relation', direction: 'write', authority: 'DERIVADO', description: 'Relação bidirecional com as transações de compra deste ciclo', aliases: ['Transações da Fatura', 'Compras'] },
      { domainField: 'paymentTransactions', notionProperty: 'Transações de Pagamento', notionType: 'relation', direction: 'both', authority: 'REGRA_AUTOMATICA', description: 'Relações com as transações bancárias de saída que quitaram ou amortizaram a fatura (suporta múltiplos pagamentos)', aliases: ['Pagamentos'] },
    ],
  },
};
